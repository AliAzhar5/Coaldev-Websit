<template>
  <div>
    ...
    <div class="relative h-[600px]">
      ...
      <div class="relative z-10 pt-32 px-6 md:px-12 text-white">
        <p class="text-2xl text-white mx-4 sm:ml-24 mt-10 sm:mt-20">
          Home > <span class="text-[#008C96]">Industries</span>
        </p>
        <h1
        ...
        >
          ...
          transform your business through cutting-edge technology.
        </p>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-10 py-12">
      <h2
        class="text-2xl sm:text-4xl lg:text-5xl font-semibold mb-4 mx-4 sm:ml-10 mt-10"
      >
        OUR EXPERTISE EXTENDS ACROSS
        <span class="text-[#008C96]">INDUSTRIES</span>
      </h2>
      <p
        class="text-base sm:text-lg lg:text-xl mx-4 sm:ml-10 mt-5 max-w-[750px] leading-normal text-gray-700"
      >
        ...
        high-quality, innovative solutions that set you apart from the
        competition.
      </p>
    </div>
    ...
    <div class="px-6 md:px-12">
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mt-8 sm:mt-16 mx-4 sm:ml-24 mb-16 sm:mb-24"
      >
        <router-link
          :to="`/industry/${industry.name.toLowerCase().replace(/\s+/g, '-')}`"
          v-for="industry in industries"
          :key="industry.name"
          class="bg-gray-50 p-6 transition-all duration-500 ease-in-out hover:bg-gray-900 group border-l-4 border-gray-900 relative overflow-hidden cursor-pointer"
        >
          <div
